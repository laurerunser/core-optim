...
\begin{proof}
  ...
  \begin{proof}
    ...
    \begin{proof}
      \step{label-1.1.1}{$\go {\scoped \aBase \env} {(\nonEmptyStack \aIteFrame {\aStack'})} = \go {\scoped {\aTerm[1]} \varnothing {\aStack'}}$}
      \begin{proof}
        \pf\ By definition of \textsf{go} and stack evaluation \ref{stack-evaluation}
      \end{proof}
      \step{label-1.1.2}{$\betaNormal {\go {\scoped {\aTerm[1]} \varnothing {\aStack'}}}$}
      \begin{proof}
        \pf\ By definition of \textsf{go} and definition of $\rightsquigarrow$ \ref{beta-reduction}
      \end{proof}
      \step{label-1.1.3}{$\go {\scoped {\aTerm[1]} \varnothing {\aStack'}}$ has the type of $\stackapp {(\nonEmptyStack \aIteFrame {\aStack'})} \true$ in the context $\aContext$}
      \begin{proof}
    ...
    \begin{proof}
        \step{label-1.1.1}{$\go {\scoped \aBase \env} {(\nonEmptyStack \aIteFrame {\aStack'})} = \go {\scoped {\aTerm[2]} \varnothing {\aStack'}}$}
        \begin{proof}
          \pf\ By definition of \textsf{go} and stack evaluation \ref{stack-evaluation}
        \end{proof}
        \step{label-1.1.2}{$\betaNormal {\go {\scoped {\aTerm[2]} \varnothing {\aStack'}}}$}
        \begin{proof}
          \pf\ By definition of \textsf{go} and definition of $\rightsquigarrow$ \ref{beta-reduction}
        \end{proof}
        \step{label-1.1.3}{$\go {\scoped {\aTerm[2]} \varnothing {\aStack'}}$ has the type of $\stackapp {(\nonEmptyStack \aIteFrame {\aStack'})} \false$ in the context $\aContext$}
        \begin{proof}
        \pf\ By \toplevel:\ref{pf:stack-typed},
        $\aRule {\judge \aContext {\aTerm[1]} {\aType[2]} \\ \judgecheck \aContext {\aType[2]} {\aTerm[2]} \\ \frameJudge \aContext {\aStack'} {\aType[2]} \aType} {\frameJudge \aContext {(\nonEmptyStack \aIteFrame {\aStack'})} \tyBool \aType} {}$
      \end{proof}
    ...
    \begin{proof}
      ...
      \end{proof}
      \step{label-1.3.2}{$\stackapp \aStack {\subs \aBase \env}$ is well-typed in the context $\aContext$}
      \begin{proof}
        \pf\ By \toplevel:\ref{pf:stack-typed}
      \end{proof}
      ...
      \end{proof}
      \step{label-1.3.4}{$\stackapp \aStack {\subs \aBase \env}$ has the type of $\stackapp \aStack {\subs \aBase \env}$ in the context $\aContext$}
    \end{proof}
  \end{proof}
  ...
  \begin{proof}
    ...
    \begin{proof}
      ...
      \begin{proof}
        ...
        \end{proof}
        \step{label-2.1.2.3}{$\subs {\aTerm[3]} {\envextend \env \aVar \aBase}$ is well-typed in the context $\aContext$}
        \begin{proof}
          ...
          \begin{proof}
            ...
            \aVar[1] \notin FV(t) \cup FV(\env)} {\judge \aContext {\subs {(\tfun \aVar \aType {\aTerm[3]})} \env} {{\subs \aType \env} \to \aType[3]}} {}$ 
          \end{proof}
          \step{label-2.1.2.3.2}{$\judge \aContext \aBase {\subs \aType \env}$}
          \begin{proof}
            \pf\ By \toplevel:\ref{pf:stack-typed},
            $\aRule {\frameJudge \aContext {\aStack'} {\aType[3]} {\aType[2]} \\ \judgecheck \aContext {\subs \aType \env} \aBase}
            {\frameJudge \aContext {\nonEmptyStack \aFunFrame {\aStack'}} {{\subs \aType \env} \to {\aType[3]}} {\aType[2]}} {}$
          \end{proof}
          \step{label-2.1.2.3.3}{$\judge \aContext {\subs {\aTerm[3]} {\envextend \env \aVar \aBase}} {\aType[3]}$}
          \begin{proof}
            \pf\ By term typechecker
          \end{proof}
        \end{proof}
        \step{label-2.1.2.4}{$\aStack'$ is well-typed in the context $\aContext$ for the type of $\subs {\aTerm[3]} {\envextend \env \aVar \aBase}$}
        \begin{proof}
          \step{label-2.1.2.4.1}{$\judge \aContext {\subs {\aTerm[3]} {\envextend \env \aVar \aBase}} {\aType[3]}$}
          \begin{proof}
            \pf\ By \stepref{label-2.1.2.3}
          \end{proof}
          \step{label-2.1.2.4.2}{$\frameJudge \aContext {\aStack'} {\aType[3]} {\aType[2]}$}
          \begin{proof}
            \pf\ By \toplevel:\ref{pf:stack-typed},
            $\aRule {\frameJudge \aContext {\aStack'} {\aType[3]} {\aType[2]} \\ \judgecheck \aContext {\subs \aType \env} \aBase}
            {\frameJudge \aContext {\nonEmptyStack \aFunFrame {\aStack'}} {{\subs \aType \env} \to {\aType[3]}} {\aType[2]}} {}$
    ...
    \begin{proof}
      ...
      \begin{proof}
        ...
        \end{proof}
        \step{label-2.2.2.3}{$\subs {\aTerm[3]} {\envextend \env \aVar {\aVar[1]}}$ is well-typed in the context $\ctxtExtend {\aContext \setminus \hasType \aVar \aType} {\aVar[1]} \aType$}
        \begin{proof}
          \pf\ Rename a variable doesn't change types
        \end{proof}
        \step{label-2.2.2.4}{$\emptyStack$ is well-typed in the context $\ctxtExtend {\aContext \setminus \hasType \aVar \aType} {\aVar[1]} \aType$ for the type of $\subs {\aTerm[3]} {\envextend \env \aVar {\aVar[1]}}$}
        \begin{proof}
  ...
  \begin{proof}
    ...
    \begin{proof}
      ...
      \begin{proof}
        ...
        \end{proof}
      \end{proof}
      \step{label-4.2.3}{$\subs {\aTerm[3]} \env$ is well-typed in the context $\aContext$}
      \begin{proof}
        \pf\ By substitution and \toplevel:\ref{pf:term-typed},
      ...
      \end{proof}
      \step{label-4.2.4}{$\nonEmptyStack {\aFunFrame[\subs \aBase \env]} \aStack$ is well-typed in the context $\aContext$ for the type of $\subs {\aTerm[3]} \env$}
      \begin{proof}
        \pf\ By \toplevel:\ref{pf:stack-typed} \\
  ...
  \begin{proof}
    ...
    \begin{proof}
      ...
      \begin{proof}
        \pf\ By the definition of well scoped stack
      \end{proof}
      \step{label-6.2.3}{$\subs {\aTerm[4]} \env$ is well-typed in the context $\aContext$}
      \begin{proof}
        \begin{proof}
          \pf\ By substitution and \toplevel:\ref{pf:term-typed},
        ...
        \end{proof}
      \end{proof}
      \step{label-6.2.4}{$\emptyStack$ is well-typed in the context $\aContext$ for the type of $\subs {\aTerm[4]} \env$}
      \begin{proof}
        \pf\ By empty stack rule \ref{stack-typechecker}
      \end{proof}
      \qedstep
    ...
    \begin{proof}
      ...
      \end{proof}
      \step{label-6.4.3}{$\subs {\aTerm[3]} \env$ is well-typed in the context $\aContext$}
      \begin{proof}
        \pf\ By substitution and \toplevel:\ref{pf:term-typed},
        $\aRule {\judge \aContext {\subs {\aTerm[3]} \env} {\tyBool}\\ \judge \aContext {\subs {\aTerm[4]} \env} \aType \\ \judgecheck \aContext \aType {\subs {\aTerm[5]} \env}} {\judge \aContext {\subs {(\ite {\aTerm[3]} {\aTerm[4]} {\aTerm[5]})} \env} \aType} {}$
      \end{proof}
      \step{label-6.4.4}{$\nonEmptyStack {\aIteFrameAll {(\go {\scoped {\aTerm[4]} \env} \emptyStack)} {(\go {\scoped {\aTerm[5]} \env} \emptyStack)}} \aStack$ is well-typed in the context $\aContext$ for the type of $\subs {\aTerm[3]} \env$}
      \begin{proof}
        \pf\ By \toplevel:\ref{pf:stack-typed}, 
