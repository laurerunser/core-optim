...
\section{Typechecker}
\subsection{Type synthesis for terms}
...
\end{mathpar}
\subsection{Type synthesis for stacks}
...
\begin{proof}
  \assume{\begin{pfenum}
            \item $\scoped \aTerm \env$ is a well-scoped term in the context $\aContext$ \label{pf:term-scoped}
            \item $\scoped \aTerm \env$ is well-scoped in regards to the stack $\aStack$ \label{pf:term-plug}
            \item $\forall \aTerm \in \aStack, \aTerm \not\rightsquigarrow$ \label{pf:term-in-stack}
          \end{pfenum}}
  ...
  \begin{proof}
    ...
    \begin{proof}
      ...
      \end{proof}
      \step{label-1.1.2}{$\stackapp {\aStack'} {\aTerm[1]} \not\rightsquigarrow$}
      \begin{proof}
        \pf\ By \toplevel:\ref{pf:term-in-stack} and definition of $\rightsquigarrow$ \ref{beta-reduction}
      \end{proof}
      \step{label-1.1.3}{$\stackapp {(\nonEmptyStack \aIteFrame {\aStack'})} \true \rightsquigarrow \stackapp {\aStack'} {\aTerm[1]}$}
      \begin{proof}
    ...
    \begin{proof}
      ...
      \begin{proof}
        \pf\ By definition of \textsf{go}
      \end{proof}
      \step{label-1.2.2}{$\stackapp {\aStack'} {\aTerm[2]} \not\rightsquigarrow$}
      \begin{proof}
        \pf\ By \toplevel:\ref{pf:term-in-stack} and definition of $\rightsquigarrow$
      \end{proof}
      \step{label-1.2.3}{$\stackapp {(\nonEmptyStack \aIteFrame {\aStack'})} \false \rightsquigarrow \stackapp {\aStack'} {\aTerm[2]} $}
      \begin{proof}
    ...
    \begin{proof}
      ...
      \begin{proof}
        \pf\ By definition of \textsf{go}
      \end{proof}
      \step{label-1.3.2}{$\stackapp \aStack {\subs \aBase \env} \not\rightsquigarrow$}
      \begin{proof}
        \pf\ By definition of stack evaluation and $\rightsquigarrow$
      \end{proof}
    \end{proof}
  ...
  \begin{proof}
    ...
    \begin{proof}
      ...
      \begin{proof}
        \pf\ By definition of \textsf{go}
      \end{proof}
      \step{label-2.1.2}{$\stackapp {\aStack'} {\subs {\aTerm[3]} {\envextend \env \aVar \aBase}} \rightsquigarrow^* \go {\scoped {\aTerm[3]} {\envextend \env \aVar \aBase}} {\aStack'} \not\rightsquigarrow$}
      \begin{proof}
        ...
        \begin{proof}
          ...
          \end{proof}
        \end{proof}
        \step{label-2.1.2.2}{$\forall \aTerm' \in \aStack', \aTerm' \not\rightsquigarrow$}
        \begin{proof}
        ...
        \end{proof}
      \end{proof}
      \step{label-2.1.3}{$\stackapp {(\nonEmptyStack \aFunFrame {\aStack'})} {\subs {(\tfun \aVar \aType {\aTerm[3]})} \env} \rightsquigarrow \stackapp {\aStack'} {\subs {\aTerm[3]} {\envextend \env \aVar \aBase}}$}
      \begin{proof}
        \pf\ \\
        $\begin{aligned}[t]
    ...
    \begin{proof}
      ...
      \begin{proof}
        \pf\ By definition of \textsf{go}
      \end{proof}
      \step{label-2.2.2}{$\subs {\aTerm[3]} {\envextend \env \aVar {\aVar[1]}} \rightsquigarrow^* \go {\scoped {\aTerm[3]} {\envextend \env \aVar {\aVar[1]}}} \emptyStack \not\rightsquigarrow$}
      \begin{proof}
        ...
        \begin{proof}
          ...
          \end{proof}
        \end{proof}
        \step{label-2.2.2.2}{$\scoped {\aTerm[3]} {\envextend \env \aVar {\aVar[1]}}$ can be plugged into the stack $\aStack$}
        \begin{proof}
          \pf\ \textsf{go} preserves typing, so $\scoped {\aTerm[3]} \env$ has the same type than $\scoped {\aTerm[3]} {\envextend \env \aVar {\aVar[1]}}$,
        and is therefore well-scoped in regards to the stack $\aStack$ by \toplevel:\ref{pf:term-plug}
          \end{proof}
        \step{label-2.2.2.3}{$\forall \aTerm' \in \emptyStack, \aTerm' \not\rightsquigarrow$}
        \qedstep
        \begin{proof}
          \pf\ By IH
        \end{proof}
      \end{proof}
      \step{label-2.2.3}{$\stackapp \aStack {\subs {(\tfun \aVar \aType {\aTerm[3]})} \env} \rightsquigarrow^* \stackapp \aStack {\tfun {\aVar[1]} {\subs \aType \env} {\go {\scoped {\aTerm[3]} {\envextend \env \aVar {\aVar[1]}}} \emptyStack}}$ with $\aVar[1] \notin FV(\aTerm) \cup FV(\env)$}
      \begin{proof}
  ...
  \begin{proof}
    ...
    \begin{proof}
      ...
      \step{label-3.1.2}{$\stackapp {\aStack'} {\subs {\aTerm[3]} {\envextend \env \aTypeVar {\aType[1]}}} \rightsquigarrow^* \go {\scoped {\aTerm[3]} {\envextend \env \aTypeVar {\aType[1]}}} {\aStack'} \not\rightsquigarrow$}
      \step{label-3.1.3}{$\stackapp {(\nonEmptyStack \aPolyFrame {\aStack'})} {\subs {(\ttyfun \aTypeVar {\aTerm[3]})} \env} \rightsquigarrow \stackapp {\aStack'} {\subs {\aTerm[3]} {\envextend \env \aTypeVar {\aType[1]}}}$}
    \end{proof}
    ...
    \begin{proof}
      ...
      \step{label-3.2.2}{$\subs {\aTerm[3]} {\envextend \env \aTypeVar {\aTypeVar[1]}} \rightsquigarrow^* \go {\scoped {\aTerm[3]} {\envextend \env \aTypeVar {\aTypeVar[1]}}} \emptyStack \not\rightsquigarrow $}
      \step{label-3.2.3}{$\stackapp \aStack {\subs {(\ttyfun \aTypeVar {\aTerm[3]})} \env} \rightsquigarrow^* \stackapp \aStack {\ttyfun {\aTypeVar[1]} {\aTerm[2]}}$ with $\aVar[1] \notin FV(\aTerm) \cup FV(\env)$ and $\subs {\aTerm[3]} {\envextend \env \aTypeVar {\aTypeVar[1]}} \rightsquigarrow^* \aTerm[2]$}
    \end{proof}
  \end{proof}
  ...
  \begin{proof}
    ...
    \begin{proof}
      \pf\ By definition of \textsf{go}
    \end{proof}
    \step{label-4.2}{$\stackapp {(\nonEmptyStack {\aFunFrame[\subs \aBase \env]} \aStack)} {\subs {\aTerm[3]} \env} \rightsquigarrow^* \go {\scoped {\aTerm[3]} \env} {(\nonEmptyStack {\aFunFrame[\subs \aBase \env]} \aStack)} \not\rightsquigarrow$}
    \begin{proof}
      ...
      \begin{proof}
        ...
        \end{proof}
      \end{proof}
      \step{label-4.2.2}{$\forall \aTerm' \in (\nonEmptyStack {\aFunFrame[\subs \aBase \env]} \aStack), \aTerm' \not\rightsquigarrow$}
      \begin{proof}
        \step{label-4.2.2.1}{$\subs \aBase \env \not\rightsquigarrow$}
        \begin{proof}
  ...
  \begin{proof}
    ...
    \step{label-5.2}{$\stackapp {(\nonEmptyStack {\aPolyFrame[\subs {\aType[1]} \env]} \aStack)} {\subs {\aTerm[3]} \env} \rightsquigarrow^* \go {\scoped {\aTerm[3]} \env} {(\nonEmptyStack {\aPolyFrame[\subs {\aType[1]} \env]} \aStack)} \not\rightsquigarrow$}
  ...
  \begin{proof}
    ...
    \begin{proof}
      \pf\ By definition of \textsf{go}
    \end{proof}
    \step{label-6.2}{$\subs {\aTerm[4]} \env \rightsquigarrow {\go {\scoped {\aTerm[4]} \env} \emptyStack} \not\rightsquigarrow$} \label{pf:6-2}
    \begin{proof}
      ...
      \begin{proof}
        ...
        \end{proof}
      \end{proof}
      \step{label-6.2.2}{$\forall \aTerm' \in \emptyStack, \aTerm' \not\rightsquigarrow$}
      \qedstep
      \begin{proof}
        \pf\ By IH
      \end{proof}
    \end{proof}
    \step{label-6.3}{$\subs {\aTerm[5]} \env \rightsquigarrow {\go {\scoped {\aTerm[5]} \env} \emptyStack} \not\rightsquigarrow$}
    \step{label-6.4}{$\stackapp {(\nonEmptyStack {\aIteFrameAll {(\go {\scoped {\aTerm[4]} \env} \emptyStack)} {(\go {\scoped {\aTerm[5]} \env} \emptyStack)}} \aStack)} {\subs {\aTerm[3]} \env} \rightsquigarrow^* \go {\scoped {\aTerm[3]} \env {(\nonEmptyStack {\aIteFrameAll {(\go {\scoped {\aTerm[4]} \env} \emptyStack)} {(\go {\scoped {\aTerm[5]} \env} \emptyStack)}} \aStack)}} \not\rightsquigarrow$}
    \begin{proof}
      ...
      \begin{proof}
        ...
        \end{proof}
      \end{proof}
      \step{label-6.4.2}{$\forall \aTerm' \in ((\nonEmptyStack {\aIteFrameAll {(\go {\scoped {\aTerm[4]} \env} \emptyStack)} {(\go {\scoped {\aTerm[5]} \env} \emptyStack)}} \aStack)), \aTerm' \not\rightsquigarrow$}
      \begin{proof}
  ...
  \begin{proof}
    ...
    \step{label-7.2}{$\subs {\aTerm[4]} {\envextend \env \aVar {\aVar[1]}} \rightsquigarrow^* \go {\scoped {\aTerm[4]} {\envextend \env \aVar {\aVar[1]}}} \emptyStack \not\rightsquigarrow$}
    \step{label-7.3}{$\subs {\aTerm[3]} \env \rightsquigarrow^* \go {\scoped {\aTerm[3]} \env} \emptyStack \not\rightsquigarrow$}
    \step{label-7.4}{$\stackapp \aStack {\subs {(\tlet \aVar {\aTerm[3]} {\aTerm[4]})} \env} \rightsquigarrow^* \stackapp \aStack {(\tlet {\aVar[1]} {\go {\scoped {\aTerm[3]} \env} \emptyStack} {\go {\scoped {\aTerm[4]} {\envextend \env \aVar {\aVar[1]}}} \emptyStack})} \text{ with } \aVar[1] \notin FV(\aTerm) \cup FV(\env)$}
  \end{proof}
  ...
  \begin{proof}
    ...
    \step{label-8.2}{$\stackapp \aStack {\subs {\aTerm[3]} \env} \rightsquigarrow^* \go {\scoped {\aTerm[3]} \env} \aStack \not\rightsquigarrow$}
    \step{label-8.3}{$\stackapp \aStack {\subs {\ttyann {\aTerm[3]} \aType} \env} \rightsquigarrow \stackapp \aStack {\subs {\aTerm[3]} \env}$}
  \end{proof}
\end{proof}
