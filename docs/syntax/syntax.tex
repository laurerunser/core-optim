...
\subsection{Fully-simplified} \label{simplified-stack}
$\aStack$ is fully-simplified if $\forall \aTerm \in \aStack, \betaNormal{\aTerm}$
...
\begin{proof}
  ...
  \end{enumerate}}
  \assume{$\exists \aType. \exists \aType[1]$ such that
    \begin{enumerate}
  ...
  \begin{proof}
    ...
    \begin{proof}
      \step{label-1.1.1}{$\go {\scoped \aBase \env} {(\nonEmptyStack \aIteFrame {\aStack'})} = \go {\scoped {\aTerm[1]} \envid {\aStack'}}$}
      \begin{proof}
        \pf\ By definition of \textsf{go}
      \end{proof}
      \step{label-1.1.2}{$\simplBeta[*] {\stackapp {\aStack'} {\subs {\aTerm[1]} \envid}} {\betaNormal {\go {\scoped {\aTerm[1]} \envid {\aStack'}}}}$ and $\judge \aContext {\go {\scoped {\aTerm[1]} \envid {\aStack'}}} {\aType[1]}$}
      \begin{proof}
        \step{label-1.1.2.1}{$\scoped {\aTerm[1]} \envid$ is well-scoped}
        \begin{proof}
          \pf\ No ??
        \end{proof}
        \step{label-1.1.2.2}{$\aStack'$ is fully-simplified}
        \begin{proof}
          \pf\ By \ref{pf:term-in-stack}
        \end{proof}
        \step{label-1.1.2.3}{$\judge \aContext {\subs {\aTerm[1]} \envid} {\aType[2]}$ and $\frameJudge \aContext {\aStack'} {\aType[2]} {\aType[1]}$}
        \begin{proof}
        ...
        \end{proof}
      \end{proof}
      \step{label-1.1.3}{$\simplBeta {\stackapp {(\nonEmptyStack \aIteFrame {\aStack'})} \true} {\stackapp {\aStack'} {\subs {\aTerm[1]} \envid}}$}
      \begin{proof}
        \pf\ By stack evaluation \ref{stack-evaluation} and $\rightsquigarrow$
      \end{proof}
    \end{proof}
    \step{label-1.2}{\case{$\subs \aBase \env = \false$ and $\aStack = \nonEmptyStack \aIteFrame {\aStack'}$}}
    \begin{proof}
      \step{label-1.2.1}{$\go {\scoped \aBase \env} {(\nonEmptyStack \aIteFrame {\aStack'})} = \go {\scoped {\aTerm[2]} \envid {\aStack'}}$}
      \begin{proof}
        \pf\ By definition of \textsf{go}
      \end{proof}
      \step{label-1.2.2}{$\simplBeta[*] {\stackapp {\aStack'} {\subs {\aTerm[2]} \envid}} {\betaNormal {\go {\scoped {\aTerm[2]} \envid {\aStack'}}}}$ and $\judge \aContext {\go {\scoped {\aTerm[2]} \envid {\aStack'}}} {\aType[1]}$}
      \begin{proof}
        \step{label-1.2.2.1}{$\scoped {\aTerm[2]} \envid$ is well-scoped}
        \begin{proof}
          \pf\ No ??
        \end{proof}
        \step{label-1.2.2.2}{$\aStack'$ is fully-simplified}
        \begin{proof}
          \pf\ By \ref{pf:term-in-stack}
        \end{proof}
        \step{label-1.2.2.3}{$\judge \aContext {\subs {\aTerm[2]} \envid} {\aType[2]}$ and $\frameJudge \aContext {\aStack'} {\aType[2]} {\aType[1]}$}
        \begin{proof}
          \pf\ By \toplevel:\ref{pf:stack-typed}
        \end{proof}
        \qedstep
        ...
        \end{proof}
      \end{proof}
      \step{label-1.2.3}{$\simplBeta {\stackapp {(\nonEmptyStack \aIteFrame {\aStack'})} \false} {\stackapp {\aStack'} {\subs {\aTerm[2]} \envid}}$}
      \begin{proof}
        \pf\ By stack evaluation \ref{stack-evaluation} and $\rightsquigarrow$
      \end{proof}
    \end{proof}
