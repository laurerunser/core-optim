    ...
    \begin{proof}
      ...
      \begin{proof}
        ...
        \begin{proof}
          ...
          \begin{proof}
            \step{label-2.1.2.1.3.1}{$\judge \aContext {\subs {\subs {\aTerm[3]} {\envExtend \env \aVar {\aVar[1]}}} {\envElem {\aVar[1]} {\subs \aBase {\env'}}}} {\aType[3]}$}
            \begin{proof}
              \pf\ By \stepref{label-2.1.2.1.1}, \stepref{label-2.1.2.1.2} and lemma \ref{term-lemma-substitution}
            \end{proof}
            \qedstep
            \begin{proof}
