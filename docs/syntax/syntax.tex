...
\begin{proof}
  ...
  \step{label-3}{\case{$\aTerm = \ttyapp {\aTerm'} \aType$}}
    \begin{proof}
    \step{label-3.1}{$\betaNormal{\aTerm'}$}
    \begin{proof}
      \step{label-3.1.1}{$\aTerm'$ is neutral}
      \begin{proof}
        \pf\ By inversion of hypothesis
      \end{proof}
      \qedstep
  ...
  \step{label-4}{\case{$\aTerm = \ite {\aTerm[3]}{\aTerm[4]}{\aTerm[5]}$}}
    \begin{proof}
    \step{label-2.1}{$\betaNormal{\aTerm[3]}$}
    \begin{proof}
      \step{label-2.1.1}{$\aTerm[3]$ is neutral}
      \begin{proof}
        \pf\ By inversion of hypothesis
      \end{proof}
      \qedstep
...
\begin{proof}
    ...
    \begin{proof}
      ...
      \begin{proof}
        ...
        \begin{proof}
          \pf\ By definition of \textsf{go}
        \end{proof}
        \step{label-1.1.3.2}{$\plug \aStack (\subs \aTerm \env) = \subs \aTerm \env$}
        \begin{proof}
          \pf\ By definition of \textsf{plug}
        \end{proof}
        \step{label-1.1.3.3}{$\stackapp \aStack {\subs \aTerm \env} = \subs \aTerm \env$}
        \begin{proof}
          \pf\ By definition of $\stackapp {\_} {\_}$
        \end{proof}
        \step{label-1.1.3.4}{$\betaNormal{\subs \aTerm \env}$}
        \begin{proof}
          \pf\ By definition of $\rightsquigarrow$
        \end{proof}
        \qedstep
  ...
  \begin{proof}
    \step{label-2.1}{$\begin{disj} \aStack = \nonEmptyStack {\aFunFrame[\env']} {\aStack'} \\ \aStack = \emptyStack \end{disj}$}
    \begin{proof}
      \step{label-2.1.1}{$\exists \aType[1]$ such that $\aType = \aType[2] \to \aType[1]$}
        \begin{proof}
          \pf\ By inversion of \ref{pf:term-typed}
        \end{proof}
        \qedstep
        ...
        \end{proof}
    \end{proof}
    \step{label-2.2}{\case{$\aStack = \nonEmptyStack {\aFunFrame[\env']} {\aStack'}$ (line~\ref{go:fun-holefun})}}
    \begin{proof}
      \pflet{$\env'' = \envExtend \env \aVar {\subs \aBase {\env'}}$}
      \step{label-2.2.1}{$\go {\scoped {\aTerm} \env} \aStack = \go {\scoped {\aTerm[3]} {\env''}} {\aStack'}$}
      \begin{proof}
        \pf\ By definition of \textsf{go}
      \end{proof}
      \step{label-2.2.2}{$\simplBeta[*] {\stackapp {\aStack'} {\subs {\aTerm[3]} {\env''}}} {\betaNormal {\go {\scoped {\aTerm[3]} {\env''}} {\aStack'}}}$}
      \begin{proof}
        \step{label-2.2.2.1}{$\exists \aType[3]$ such that $\begin{conj}\aType = \subs {\aType[2]} \env \to \aType[3] \\ \judge {\aContext} {\subs {\aTerm[3]} {\env''}} {\aType[3]} \\ \frameJudge {\aContext} {\aStack'} {\aType[3]} {\aType[1]} \end{conj}$}
        \begin{proof}
          \step{label-2.2.2.1.1}{$\exists \aType[3]$ such that $\begin{conj} \aType = \subs {\aType[2]} \env \to \aType[3] \\ \judge {\ctxtExtend \aContext {\aVar[1]} {\subs {\aType[2]} \env}} {\subs {\aTerm[3]} {\envExtend \env \aVar {\aVar[1]}}} \aType[3]$ with $\aVar[1] \notin FV(\aTerm) \cup FV(\env) \end{conj}$}
          \begin{proof}
            \pf\ By substitution and inversion of \ref{pf:term-typed}
          \end{proof}
          \step{label-2.2.2.1.2}{$\begin{conj} \judge \aContext {\subs \aBase {\env'}} {\subs {\aType[2]} \env} \\ \frameJudge \aContext {\aStack'} {\aType[3]} {\aType[1]} \end{conj}$}
          \begin{proof}
            \pf\ By inversion of \ref{pf:stack-typed}
          \end{proof}
          \step{label-2.2.2.1.3}{$\judge \aContext {\subs {\aTerm[3]} {\env''}} {\aType[3]}$}
          \begin{proof}
            \step{label-2.2.2.1.3.1}{$\judge \aContext {\subs {\subs {\aTerm[3]} {\envExtend \env \aVar {\aVar[1]}}} {\envElem {\aVar[1]} {\subs \aBase {\env'}}}} {\aType[3]}$}
            \begin{proof}
              \pf\ By \stepref{label-2.2.2.1.1}, \stepref{label-2.2.2.1.2} and lemma \ref{lemma-term-substitution}
            \end{proof}
            \qedstep
            \begin{proof}
        ...
        \end{proof}
      \end{proof}
      \step{label-2.2.3}{$\simplBeta {\stackapp {\aStack} {\subs {\aTerm} \env}}{\stackapp {\aStack'} {\subs {\aTerm[3]} {\env''}}}$}
      \begin{proof}
        \pf\ \\
      ...
      \end{proof}
    \end{proof}
    \step{label-2.3}{\case{$\aStack = \emptyStack$ (line~\ref{go:fun-else})}}
    \begin{proof}
      \pflet{$\begin{conj}
        \aVar[1] \notin FV(\aTerm) \cup FV(\env) \\
      ...
      \end{conj}$}
      \step{label-2.3.1}{$\go {\scoped {\aTerm} \env} \aStack = \plug \aStack {\aTerm'}$}
      \begin{proof}
        \pf\ By definition of \textsf{go}
      \end{proof}
      \step{label-2.3.2}{$\simplBeta[*] {\stackapp \aStack {\subs \aTerm \env}} {\betaNormal {\plug \aStack {\aTerm'}}}$}
      \begin{proof}
        \step{label-2.3.2.1}{$\simplBeta[*]{\subs \aTerm \env} {\betaNormal{\aTerm'}}$}
        \begin{proof}
          \step{label-2.3.2.1.1}{$\simplBeta[*] {\stackapp {\emptyStack} {\subs {\aTerm[3]} {\env'}}} {\betaNormal {\go {\scoped {\aTerm[3]} {\env'}} {\emptyStack}}}$}
          \begin{proof}
            \step{label-2.3.2.1.1.1}{$\exists \aContext', \aType[3]$ such that $\begin{conj}\aType = \subs {\aType[2]} \env \to \aType[3] \\ \judge {\aContext'} {\subs {\aTerm[3]} {\env'}} {\aType[3]} \\ \frameJudge {\aContext'} {\emptyStack} {\aType[3]} {\aType[3]} \end{conj}$}
            \begin{proof}
              \step{label-2.3.2.1.1.1.1}{$\exists \aType[3]$ such that $\begin{conj} \aType = \subs {\aType[2]} \env \to \aType[3] \\ \judge {\ctxtExtend \aContext {\aVar[1]} {\subs {\aType[2]} \env}} {\subs {\aTerm[3]} {\env'}} {\aType[3]} \end{conj}$}
              \begin{proof}
                \pf\ By substitution and inversion of \ref{pf:term-typed}
              \end{proof}
              \step{label-2.3.2.1.1.1.2}{$\frameJudge {\ctxtExtend \aContext {\aVar[1]} {\subs {\aType[2]} \env}} {\emptyStack} {\aType[3]} {\aType[3]}$}
              \begin{proof}
                \pf\ By definition
              \end{proof}
            \end{proof}
            \step{label-2.3.2.1.1.2}{$\emptyStack$ is simplifiable}
            \begin{proof}
