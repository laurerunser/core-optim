...
\aRule   { }
         {\simplBeta {{\ite \true {\scoped \aTerm \env} {\scoped {\aTerm[1]} \env}}} {\subs \aTerm \env}}
         {}

\aRule   { }
         {\simplBeta {{\ite \false {\scoped \aTerm \env} {\scoped {\aTerm[1]} \env}}} {\subs {\aTerm[1]} \env}}
         {}
\end{mathpar}
...
Here is one example: 
$$
\ttyapp {\tapp {\ttyfun \aTypeVar {\tfun \aVar \aTypeVar 
        {\tapp {\tapp {\ttyapp { \text{smth} } {\aTypeVar[1]}} {\aVar[1]}} \aVar}}} 
        \tyBool} \true 
$$
